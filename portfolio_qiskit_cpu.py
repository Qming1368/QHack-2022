...
def portfolio_optimization(num_assets):
    ...
    qaoa_mes = QAOA(optimizer=adam, reps=3, quantum_instance=quantum_instance,include_custom=False)
...
if __name__ == "__main__":
  ...
  np.save('qiskit_cpu_runtime.npy',np.array(runtime_list))
  np.save('qiskit_cpu_solution.npy',np.array(selection_list,dtype=object))                                                                               3,5           Top
